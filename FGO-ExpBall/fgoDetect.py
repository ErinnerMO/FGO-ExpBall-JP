...
SUMMON_FP=Button((600,380),'summon_friend_point',(250,40))
...
FILTER_NONE=Button((990,595),'filter',(90,15))
FILTER_EVENT_ALL=Button((760,120),'filter_event_all',(80,20))
FILTER_EVENT=Button((760,120),'filter_event',(80,20))
FILTER_NO_EVENT=Button((804,130),'lock',(80,18))
FILTER_FILTER=Button((980,130))
FILTER_STAR_3=Button((642,235))
FILTER_STAR_2=Button((831,235))
FILTER_STAR_1=Button((1019,235))
FILTER_SCROLL_END=Button((1135,565))
FILTER_SCROOL_CATEGORY=Button((1135,190))
FILTER_SVT=Button((430,290),'filter_svt_exp_fou',(80,25))
FILTER_EXP=Button((640,290),'filter_svt_exp_fou',(80,25))
FILTER_FOU=Button((850,290),'filter_svt_exp_fou',(80,25))
